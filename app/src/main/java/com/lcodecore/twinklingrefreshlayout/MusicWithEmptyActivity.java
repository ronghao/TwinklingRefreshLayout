...
public class MusicWithEmptyActivity extends AppCompatActivity {
    ...
    private void setupListView(ListView listView) {
        TRefreshWithEmptyViewLayout refreshLayout = (TRefreshWithEmptyViewLayout) findViewById(R.id.refresh);
//        refreshLayout.setEmptyView(LayoutInflater.from(MusicWithEmptyActivity.this).inflate(R.layout.base_emptyview, null));
//        refreshLayout.setErrorView(LayoutInflater.from(MusicWithEmptyActivity.this).inflate(R.layout.base_errorview, null));
//        refreshLayout.setError(true);
        refreshLayout.setEmptyAndErrorView(LayoutInflater.from(MusicWithEmptyActivity.this).inflate(R.layout.base_emptyview, null),
                LayoutInflater.from(MusicWithEmptyActivity.this).inflate(R.layout.base_errorview, null));
